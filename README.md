...
Break bricks with the bouncing ball

## 🎮 Game Type
Standalone Android (Java)

## 📦 Package
`com.auroramarket.brickbreaker`
...
**Aurora Raye Brickbreaker** is the preferred human-readable product name for generated Aurora Rayes collateral. The repository slug stays unchanged unless a separate rename process is approved.
